...
def test_rank_jobs():
    ...
    jobs = [
        JobPosting(title="Data Scientist", company="Tech Corp", skills=["Python", "SQL", "Statistics"]),
        JobPosting(title="Software Engineer", company="Dev Inc", skills=["Python", "Java", "Design Patterns"])
    ]
